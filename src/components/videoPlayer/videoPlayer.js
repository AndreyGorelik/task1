            ...
            <div className="player-controls">
                <div className="player__video-duration">
                    ...
                    <div className="player__timebar-progress">
                        <svg width="100%" height="10" viewBox="0 0 1297 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width="100%" height="10" rx="5" fill="white" fillOpacity="0.2" />
                    ...
                    <div className="player-controls__left">
                        <button
                            ...
                            <svg width="22" height="24" viewBox="0 0 22 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd" d="M8.8 0H0V24H8.8V0ZM22 0H13.2V24H22V0Z" />
                            </svg>
                        </button>
                        <button className="player-controls__next-video">
                            <svg width="27" height="18" viewBox="0 0 27 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd" d="M10.8 0V5.985L0 0V16.5L10.8 10.5V16.5L23.25 9.9V16.5H27V0H23.25V7.425L10.8 0Z" />
                            </svg>
                        ...
                        <button
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd" d="M21.36 12C21.36 16.725 18.015 20.37 13.5 21.465V24C19.485 22.86 24 17.91 24 12C24 6.075 19.485 1.125 13.5 0V2.52C18.015 3.615 21.36 7.26 21.36 12ZM10.5 23.25L3.6 15.66H0V8.31H3.585L10.5 0.72V23.25ZM18 11.985C18 9.6 16.11 7.575 13.5 6.81V17.16C16.11 16.395 18 14.385 18 11.985Z" />
                            </svg>
                            <div className="player-controls__volume-bar">
                                <svg width="100%" height="13" viewBox="0 0 156 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="100%" height="13" rx="2.5" fill="white" fillOpacity="0.2" />
                                    <rect width="30%" height="13" rx="2.5" fill="white" />
                                </svg>
                    ...
                    <div className="player-controls__right">
                        ...
                        <button
                            ...
                            <svg width="33" height="24" viewBox="0 0 33 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd" d="M0 9H4.5V4.5H9V0H0V9ZM24 0V4.5H28.5V9H33V0H24ZM24 19.5V24H33V15H28.5V19.5H24ZM4.5 15H0V24H9V19.5H4.5V15Z" />
                            </svg>
                        </button>
                    </div>
                </div>
                ...
                <div className="player-controls-mobile-wrapper">
                    ...
                    <div className="player__timebar-mobile-progress">
                        ...
                        <div className="player__timebar-progress__bar">
                            <svg width="100%" height="5" viewBox="0 0 156 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="100%" height="5" rx="2.5" fill="white" fillOpacity="0.2" />
                                <rect width="58%" height="5" rx="2.5" fill="#FF0000" />
                            </svg>
