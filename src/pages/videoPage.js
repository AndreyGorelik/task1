...
import Pic1 from "../assets/previews/r1.png"
import Pic2 from "../assets/previews/r2.png"
import Pic3 from "../assets/previews/r3.png"
import BigPreview from "../assets/bigPreviewExample.png"
import ChannelIcon from "../assets/userpics/v4.png"
...
const recommendedVideo = {
    videos: [
        { channel: "Dollie Blair", title: "Baby Monitor Technology", views: "123k", date: "4 months", duration: "8:00", image: Pic1 },
        { channel: "Dollie Blair", title: "A Good Autoresponder", views: "123k", date: "4 months", duration: "8:00", image: Pic2 },
        { channel: "Dollie Blair", title: "Selecting The Right Hotel", views: "123k", date: "4 months", duration: "8:00", image: Pic3 }
    ]
}
            ...
            <div className="video-page-wrapper">
                <div className="video-content">
                    ...
                    <div className="video-player">
                        ...
                        <div className="video-player__constrols">
                    ...
                    <div className="video-description">
                        <div className="video-description__text">
                            ...
                            <div className="video-description__text-right-col">
                                ...
                                <span className="fullscreen-hide gray-text">{videoInfo.subscribers} subscribe</span>
                                <span className="published">Published on {videoInfo.publishedDate}</span>
                                <p>{videoInfo.description}</p>
                                <button className="gray-text mobile-hide">Show More</button>
                            </div>
                        </div>
                        <SubscribeBtn subscribers={videoInfo.subscribers} />
                        <div className="clas">
                            <button className="subscribe-light">Subscribe</button>
                        </div>
